class SelectionItensScreen extends Screen {
  ...
  void display() {
    ...
    drawItemButton(spaceship1, button1X, 246, 1);
    drawItemButton(spaceship2, button2X, 246, 2);
    drawItemButton(spaceship3, button3X, 246, 3);
    drawItemButton(spaceship4, button4X, 246, 4);
  }

  void drawItemButton(PImage buttonImage, int x, int y, int buttonId) {
